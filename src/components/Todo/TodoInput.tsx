...
// import { GetMyTodosQuery, Insert_TodosMutation, 
          // Insert_TodosMutationVariables } from '../../generated/graphql';
      ...
      addTodo(
        {
          ...
          update(cache, { data }) {
            ...
            const getExistingTodos = cache.readQuery<any>({ query: GET_MY_TODOS });
